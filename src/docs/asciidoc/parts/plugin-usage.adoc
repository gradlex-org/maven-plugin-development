...
----
include::{samples-path}/help-mojo/groovy/build.gradle[tags=help-mojo]
----
[source.multi-language-sample,kotlin]
----
include::{samples-path}/help-mojo/kotlin/build.gradle.kts[tags=help-mojo]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-path}/dependencies/groovy/build.gradle[tags=dependencies]
----
[source.multi-language-sample,kotlin]
----
include::{samples-path}/dependencies/kotlin/build.gradle.kts[tags=dependencies]
----
